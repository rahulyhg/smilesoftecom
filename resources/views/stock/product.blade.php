                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="box-tools pull-right">
                                <a href="{{ URL::to('addproduct') }}" type="button"
                                            ...
                                            @foreach ($results['products'] as  $key=>$product)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if($inventory != 0)
                                                            {{--<h1 style="color: Green">{{$inventory->stock}}</h1>--}}
                                                            <h1 style="color: Green">{{$inventory}}</h1>
                                                        @else
                                                            {{--<h1 style="color: Red">{{$inventory->stock}}</h1>--}}
            ...
            <div class="modal fade" id="deleteproductmodal" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        {!! Form::open(array('url' =>'deleteproduct', 'name'=>'deleteProduct', 'id'=>'deleteProduct', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
