<header class="main-header">
    ...
    <a href="{{ url('warehouse_dashboard')}}" class="logo">
        ...
        <span class="logo-mini" style="font-size:12px"><b>SD</b></span>
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{url('public/images/default.png')}}" class="user-image" alt="Image">
                        <span class="hidden-xs"></span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            <img src="{{url('public/images/default.png')}}" class="img-circle" alt="Image">
                        ...
                        <li class="user-footer">
                            ...
                            <div class="pull-right">
                                <a href="{{url('staff_logout')}}" class="btn btn-default btn-flat">Logout</a>
                            </div>
                        </li>
                    </ul>
                </li>
