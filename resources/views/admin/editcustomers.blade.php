                         ...
                         <div class="box-body">
                            ...
                            {!! Form::open(array('url' =>'admin/updatecustomers', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="col-sm-10 col-md-4">
                                     <label>
                                         <input @if($data['customers'][0]->customers_prime == 1 or empty($data['customers'][0]->customers_prime)) checked @endif type="radio" name="customers_prime" value="1"
                                                class="minimal"> Yes
                                     </label><br>

                                     <label>
                                         <input @if($data['customers'][0]->customers_prime == 0 or empty($data['customers'][0]->customers_prime)) checked @endif type="radio" name="customers_prime" value="0"
                                                class="minimal" > No
                                     </label>
