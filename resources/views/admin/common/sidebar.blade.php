        ...
        <ul class="sidebar-menu">
            ...
            @if(session('manufacturer_view')==1  or auth()->guard('admin')->user()->adminType=='1')
                <li class="treeview {{ Request::is('admin/manufacturers') ? 'active' : '' }} {{ Request::is('admin/addmanufacturer') ? 'active' : '' }} {{ Request::is('admin/editmanufacturer/*') ? 'active' : '' }} ">
                    <a href="{{ URL::to('admin/manufacturers')}}">
                        ...
                        <span>{{ trans('labels.link_manufacturer') }}</span>
                    </a>
                </li>
            @endif
            @if(session('categories_view')==1  or auth()->guard('admin')->user()->adminType=='1')
                <li class="treeview {{ Request::is('admin/categories') ? 'active' : '' }} {{ Request::is('admin/addcategory') ? 'active' : '' }} {{ Request::is('admin/editCategory/*') ? 'active' : '' }} {{ Request::is('admin/subcategories') ? 'active' : '' }}  {{ Request::is('admin/addsubcategory') ? 'active' : '' }}  {{ Request::is('admin/editsubcategory/*') ? 'active' : '' }}">
                    ...
                    <ul class="treeview-menu">
                        <li class="{{ Request::is('admin/categories') ? 'active' : '' }} {{ Request::is('admin/addcategory') ? 'active' : '' }} {{ Request::is('admin/editcategory/*') ? 'active' : '' }}">
            ...
            @if(session('products_view')==1  or auth()->guard('admin')->user()->adminType=='1')
                <li class="treeview {{ Request::is('admin/products') ? 'active' : '' }} {{ Request::is('admin/addproduct') ? 'active' : '' }} {{ Request::is('admin/editattributes/*') ? 'active' : '' }} {{ Request::is('admin/attributes') ? 'active' : '' }}  {{ Request::is('admin/addattributes') ? 'active' : '' }} {{ Request::is('admin/addproductattribute/*') ? 'active' : '' }} {{ Request::is('admin/addinventory/*') ? 'active' : '' }} {{ Request::is('admin/addproductimages/*') ? 'active' : '' }} ">
                    ...
                    <ul class="treeview-menu">
                        <li class="{{ Request::is('admin/products') ? 'active' : '' }} {{ Request::is('admin/addproduct') ? 'active' : '' }} {{ Request::is('admin/editproduct/*') ? 'active' : '' }} {{ Request::is('admin/addproductattribute/*') ? 'active' : '' }} {{ Request::is('admin/addinventory/*') ? 'active' : '' }} {{ Request::is('admin/addproductimages/*') ? 'active' : '' }}">
                            <a href="{{ URL::to('admin/products')}}"><i
                                        class="fa fa-circle-o"></i> {{ trans('labels.link_all_products') }}</a></li>

                        <li class="{{ Request::is('admin/attributes') ? 'active' : '' }}  {{ Request::is('admin/addattributes') ? 'active' : '' }}  {{ Request::is('admin/editattributes/*') ? 'active' : '' }}">
                            <a href="{{ URL::to('admin/attributes' )}}"><i
            ...
            @if(session('news_view')==1  or auth()->guard('admin')->user()->adminType=='1')
                <li class="treeview {{ Request::is('admin/newscategories') ? 'active' : '' }} {{ Request::is('admin/addnewscategory') ? 'active' : '' }} {{ Request::is('admin/editnewscategory/*') ? 'active' : '' }} {{ Request::is('admin/news') ? 'active' : '' }}  {{ Request::is('admin/addsubnews') ? 'active' : '' }}  {{ Request::is('admin/editsubnews/*') ? 'active' : '' }}">
                    ...
                    <ul class="treeview-menu">
                        <li class="{{ Request::is('admin/newscategories') ? 'active' : '' }} {{ Request::is('admin/addnewscategory') ? 'active' : '' }} {{ Request::is('admin/editnewscategory/*') ? 'active' : '' }}">
                            <a href="{{ URL::to('admin/newscategories')}}"><i
                                        class="fa fa-circle-o"></i>{{ trans('labels.link_news_categories') }}</a></li>
                        <li class="{{ Request::is('admin/news') ? 'active' : '' }}  {{ Request::is('admin/addsubnews') ? 'active' : '' }}  {{ Request::is('admin/editsubnews/*') ? 'active' : '' }}">
                            <a href="{{ URL::to('admin/news')}}"><i
            ...
            @if(session('tax_location_view')==1  or auth()->guard('admin')->user()->adminType=='1')
                ...
                <li class="treeview {{ Request::is('admin/countries') ? 'active' : '' }} {{ Request::is('admin/addcountry') ? 'active' : '' }} {{ Request::is('admin/editcountry/*') ? 'active' : '' }} {{ Request::is('admin/listingZones') ? 'active' : '' }} {{ Request::is('admin/listingPickups') ? 'active' : '' }} {{ Request::is('admin/addPickup') ? 'active' : '' }} {{ Request::is('admin/editPickup/*') ? 'active' : '' }} {{ Request::is('admin/taxclass') ? 'active' : '' }} {{ Request::is('admin/addtaxclass') ? 'active' : '' }} {{ Request::is('admin/editTaxClass/*') ? 'active' : '' }} {{ Request::is('admin/taxrates') ? 'active' : '' }} {{ Request::is('admin/addtaxrate') ? 'active' : '' }} {{ Request::is('admin/edittaxrate/*') ? 'active' : '' }}">
                    <a href="#">
                        <i class="fa fa-money" aria-hidden="true"></i>
                        <span>{{ trans('labels.link_tax_location') }}</span> <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        <li class="{{ Request::is('admin/countries') ? 'active' : '' }} {{ Request::is('admin/addcountry') ? 'active' : '' }} {{ Request::is('admin/editcountry/*') ? 'active' : '' }} ">
                            <a href="{{ URL::to('admin/countries')}}"><i
                                        class="fa fa-circle-o"></i> {{ trans('labels.link_countries') }}</a></li>
                        <li class="{{ Request::is('admin/taxclass') ? 'active' : '' }} {{ Request::is('admin/addtaxclass') ? 'active' : '' }} {{ Request::is('admin/editTaxClass/*') ? 'active' : '' }} ">
                            <a href="{{ URL::to('admin/taxclass')}}"><i
                                        class="fa fa-circle-o"></i> {{ trans('labels.link_tax_classes') }}</a></li>
                        <li class="{{ Request::is('admin/taxrates') ? 'active' : '' }} {{ Request::is('admin/addtaxrate') ? 'active' : '' }} {{ Request::is('admin/edittaxrate/*') ? 'active' : '' }} ">
                            <a href="{{ URL::to('admin/taxrates')}}"><i
                                        class="fa fa-circle-o"></i> {{ trans('labels.link_tax_rates') }}</a></li>
                        <li class="{{ Request::is('admin/listingZones') ? 'active' : '' }} {{ Request::is('admin/addZone') ? 'active' : '' }} {{ Request::is('admin/editZone/*') ? 'active' : '' }}">
                            <a href="{{ URL::to('admin/listingZones')}}"><i
                                        class="fa fa-circle-o"></i> {{ trans('labels.link_zones') }}</a></li>
                        <li class="{{ Request::is('admin/listingPickups') ? 'active' : '' }} {{ Request::is('admin/addPickup') ? 'active' : '' }} {{ Request::is('admin/editPickup/*') ? 'active' : '' }}">
                            <a href="{{ URL::to('admin/listingPickups')}}"><i
                                        class="fa fa-circle-o"></i> {{ trans('labels.link_pickup') }}</a></li>
                    </ul>
                </li>
            @endif
                ...
                <li class="treeview {{ Request::is('admin/devices') ? 'active' : '' }} {{ Request::is('admin/viewdevices/*') ? 'active' : '' }} {{ Request::is('admin/notifications') ? 'active' : '' }}">
                    ...
                    <ul class="treeview-menu">
                        <li class="{{ Request::is('admin/devices') ? 'active' : '' }} {{ Request::is('admin/viewdevices/*') ? 'active' : '' }}">
                            <a href="{{ URL::to('admin/devices')}}"><i
                                        class="fa fa-circle-o"></i>{{ trans('labels.link_devices') }} </a>
                        </li>
                        <li class="{{ Request::is('admin/notifications') ? 'active' : '' }} ">
                            <a href="{{ URL::to('admin/notifications') }}"><i
            ...
            @if(session('orders_view')==1)
                ...
                <li class="treeview {{ Request::is('admin/orders') ? 'active' : '' }}  {{ Request::is('admin/addOrders') ? 'active' : '' }}  {{ Request::is('admin/vieworder/*') ? 'active' : '' }}">
                    <a href="{{ URL::to('admin/orders')}}"><i class="fa fa-list-ul" aria-hidden="true"></i>
            ...
            @if(session('shipping_methods_view')==1 or auth()->guard('admin')->user()->adminType=='1')
                <li class="treeview {{ Request::is('admin/shippingmethods') ? 'active' : '' }} {{ Request::is('admin/upsShipping') ? 'active' : '' }} {{ Request::is('admin/flateRate') ? 'active' : '' }}">
                    <a href="{{ URL::to('admin/shippingmethods')}}"><i class="fa fa-truck" aria-hidden="true"></i>
            ...
            @if(session('payment_methods_view')==1 or auth()->guard('admin')->user()->adminType=='1')
                <li class="treeview {{ Request::is('admin/paymentsetting') ? 'active' : '' }}">
                    <a href="{{ URL::to('admin/paymentsetting')}}"><i class="fa fa-credit-card" aria-hidden="true"></i>
                        <span>
                    ...
                    <ul class="treeview-menu">
                        <li class="{{ Request::is('admin/lowinstock') ? 'active' : '' }} "><a
                                    href="{{ URL::to('admin/lowinstock')}}"><i
                                        class="fa fa-circle-o"></i> {{ trans('labels.link_products_low_stock') }}</a>
                        </li>
            ...
            @if(session('website_setting_view')==1 or auth()->guard('admin')->user()->adminType=='1')
                ...
                @if($web_setting[67]->value=='1')
                    <li class="treeview {{ Request::is('admin/sliders') ? 'active' : '' }} {{ Request::is('admin/addsliderimage') ? 'active' : '' }} {{ Request::is('admin/editslide/*') ? 'active' : '' }} {{ Request::is('admin/webpages') ? 'active' : '' }}  {{ Request::is('admin/addwebpage') ? 'active' : '' }}  {{ Request::is('admin/editwebpage/*') ? 'active' : '' }} {{ Request::is('admin/websettings') ? 'active' : '' }} {{ Request::is('admin/webthemes') ? 'active' : '' }} {{ Request::is('admin/customstyle') ? 'active' : '' }} {{ Request::is('admin/constantbanners') ? 'active' : '' }} {{ Request::is('admin/addconstantbanner') ? 'active' : '' }} {{ Request::is('admin/editconstantbanner/*') ? 'active' : '' }}">
                        ...
                        <ul class="treeview-menu">
                            <li class="{{ Request::is('admin/constantbanners') ? 'active' : '' }} {{ Request::is('admin/addconstantbanner') ? 'active' : '' }} {{ Request::is('admin/editconstantbanner/*') ? 'active' : '' }}">
                                <a href="{{ URL::to('admin/constantbanners')}}"><i
                                            class="fa fa-circle-o"></i> {{ trans('labels.link_Constant_Banners') }}</a>
                            </li>
                            ...
                            <li class="{{ Request::is('admin/webthemes') ? 'active' : '' }} "><a
                                        href="{{ URL::to('admin/webthemes')}}"><i
                                            class="fa fa-circle-o"></i> {{ trans('labels.website_themes') }}</a></li>

                            <li class="{{ Request::is('admin/seo') ? 'active' : '' }} "><a
                                        href="{{ URL::to('admin/seo')}}"><i
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="{{ Request::is('admin/pushnotification') ? 'active' : '' }}"><a
                                    href="{{ URL::to('admin/pushnotification')}}"><i
                                        class="fa fa-circle-o"></i> {{ trans('labels.link_push_notification') }}</a>
                        </li>
            ...
            @if(session('manage_admins_view')==1 or auth()->guard('admin')->user()->adminType=='1')
                <li class="treeview {{ Request::is('admin/admins') ? 'active' : '' }} {{ Request::is('admin/addadmins') ? 'active' : '' }} {{ Request::is('admin/editadmin/*') ? 'active' : '' }} {{ Request::is('admin/manageroles') ? 'active' : '' }} {{ Request::is('admin/addadminType') ? 'active' : '' }} {{ Request::is('admin/editadminType/*') ? 'active' : '' }}">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="{{ Request::is('admin/categoriesroles') ? 'active' : '' }} {{ Request::is('admin/categoriesroles') ? 'active' : '' }} {{ Request::is('admin/categoriesroles/*') ? 'active' : '' }}">
                            <a href="{{ URL::to('admin/categoriesroles')}}"><i
                                        class="fa fa-circle-o"></i> {{ trans('labels.link_categoriesroles') }}</a></li>
