        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                @if($result['products'][0]->products_type==1)
                    <li>
                        <a href="{{ URL::to('admin/addproductattribute/'.$result['products'][0]->products_id) }}">{{ trans('labels.AddOptions') }}</a>
                    </li>
                @endif
                                          ...
                                          {{ trans('labels.Reference / Purchase Code Text') }}</span>
                                            ...
                                            {{ trans('labels.Min Level Text') }}</span>
                                                ...
                                                <div class="box-footer col-xs-12">
                                                    @if($result['products'][0]->products_type==1)
                                                        <a href="{{ URL::to('admin/addproductattribute/'.$result['products'][0]->products_id) }}"
                                                    ...
                                                    @endif
                                                    <a href="{{ URL::to("admin/addproductimages/{$result['products'][0]->products_id}")}}"
