...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1>Edit Supplier <small>Edit Supplier...</small> </h1>
    <ol class="breadcrumb">
            ...
            <div class="row">
              <div class="col-xs-12">
              		<div class="box box-info">
                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                            <form action="{{ url('admin/updatesupplier').'/'.$supplier->id }}" method="get" id="insert_store">
                                {{-- @csrf --}}
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="" class="pull-left">Supplier Name *</label>
                                            <input type="text" name="name" value="{{ $supplier->name }}" autocomplete="off"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $supplier->contact }}" name="contact" autocomplete="off"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                   ...
                                                   id="address"
                                                   autocomplete="off"
                                                   class="form-control required" value="{{ $supplier->address }}"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $supplier->account }}"
                                                   name="account"
                                                   maxlength="25"
                                                   id="account"
                                                   autocomplete="off"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $supplier->gst_no }}"
                                                   name="gst_no"
                                                   maxlength="20"
                                                   id="gst_no"
                                                   autocomplete="off"
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-primary pull-left">Update Supplier &nbsp;<i
