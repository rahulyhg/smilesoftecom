                          ...
                          @endif
                            ...
                            {!! Form::open(array('url' =>'admin/addnewproduct', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                            	<div class="form-group">
                                  <label for="name" class="col-sm-2 col-md-3 control-label">Barcode</label>
                                  <div class="col-sm-10 col-md-4">
                                        
                                        <input type="text" value="{{ time() }}" name="barcode" id="barcode" class="form-control" placeholder="Scan / Enter Your Barcoad No">
                                      <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">Add Your Own Barcode.</span>
                                  </div>
                                </div>
                              ...
                              @endforeach
                                ...
                                <div class="form-group">
                                  <label for="name" class="col-sm-2 col-md-3 control-label">Product Purchase Price</label>
                                  <div class="col-sm-10 col-md-4">
                                ...
                                <div class="form-group">
                                  <label for="name" class="col-sm-2 col-md-3 control-label">Product Selling Price</label>
                                  <div class="col-sm-10 col-md-4">
                              ...
                              <div class="form-group">
                                  <label for="name" class="col-sm-2 col-md-3 control-label">Prime
                                      Percent</label>
                                  <div class="col-sm-10 col-md-4">
                                      <input type="text" value="0" maxlength="5" name="prime_percent" id="prime_percent" class="form-control">
                                      <span class="help-block"
                                            style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
