                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-4">
                                                ...
                                                @if(in_array($categories->id,$cat_array))
                                                    <li href="#" class="list-group-item"><label
                                                                style="width:100%"><input
                                                                    id="categories_<?=$categories->id?>" type="checkbox"
                                                                    class=" required_one categories" name="categories[]"
                                    ...
                                    <span class="help-block"
                                          style="font-weight: normal;font-size: 11px;margin-bottom: 0;"></span>
                                    ...
                                    <div class="col-md-12">
                                                    ...
                                                    <div class="col-xs-12">
                                                        ...
                                                        <span class="glyphicon glyphicon-exclamation-sign"
                                                              aria-hidden="true"></span>
                                                                            <span class="sr-only">{{ trans('labels.Error') }}
                                                                                :</span>
                                                                            {{ $error }}
                                                                        </div>
                                                                    @endforeach
                                      ...
                                      {{ trans('labels.Product Type Text') }}.</span>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="barcode"
                                                                           class="col-sm-2 col-md-3 control-label">Product
                                                                        Barcode</label>
                                                                    <div class="col-sm-10 col-md-4">
                                                                        <input type="text"
                                                                        ...
                                                                        <span class="help-block"
                                                                              style="font-weight: normal;font-size: 11px;margin-bottom: 0;">Please Enter the Barcode Number</span>
                                                                    </div>
                                                                </div>
                                      ...
                                      {{ trans('labels.ChooseManufacturerText') }}.</span>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-10 col-md-4">
                                                                        <select class="form-control"
                                                                                onChange="showFlash()" name="isFlash"
                                                                                id="isFlash">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-10 col-md-2">
                                                                            <input class="form-control datepicker"
                                                                                   readonly type="text"
                                                                                   name="flash_start_date"
                                                                                   id="flash_start_date" readonly
                                                                                   value="">
                                                                            <span class="help-block"
                                                                                  style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                      {{ trans('labels.FlashSaleDateText') }}</span>
                                                                        ...
                                                                        <div class="col-sm-10 col-md-2 bootstrap-timepicker">
                                                                            <input type="text"
                                                                                   ...
                                                                                   name="flash_start_time" readonly
                                                                                   id="flash_start_time"
                                                                                   value="">
                                                                            <span class="help-block hidden">{{ trans('labels.textRequiredFieldMessage') }}</span>
                                                                        </div>
                                  ...
                                  {{ trans('labels.SpecialProductText') }}.</span>
                                    ...
                                    {{ trans('labels.UploadProductImageText') }}</span>
                                      ...
                                      {{ trans('labels.IsFeatureProuctsText') }}</span>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="name"
                                                                           class="col-sm-2 col-md-3 control-label">Prime
                                                                        Discount </label>
                                                                    <div class="col-sm-10 col-md-4">
                                                                        <select class="form-control"
                                                                                onclick="showPrimePercent(this);"
                                                                                name="is_prime">
                                      ...
                                      {{ trans('labels.SelectStatus') }}</span>
                                                                ...
                                                                <div class="box-footer text-center">
                                                                    <button type="submit"
                                                                            ...
                                                                            id="normal-btn">{{ trans('labels.Add Atrributes') }}
                                                                        <i
                                                                                class="fa fa-angle-right 2x"></i>
                                                                    </button>
                                                                    <button type="submit"
                                                                            class="btn btn-primary pull-right"
                                                                            id="external-btn"
                                                                            style="display: none">{{ trans('labels.addinventory') }}
                                                                        <i
                                                                                class="fa fa-angle-right 2x"></i>
                                                                    </button>
                                                                </div>
