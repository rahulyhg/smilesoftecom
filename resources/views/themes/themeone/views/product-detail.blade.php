                                    ...
                                    <form name="attributes" id="add-Product-form" method="post" >
                                        ...
                                        <div class="form-inline product-box">
                                            ...
                                            <div class="price-box">
                                                ...
                                                @if(!empty($result['detail']['product_data'][0]->flash_price))
                                                	{{$web_setting[19]->value}}{{$result['detail']['product_data'][0]->products_min_order*$result['detail']['product_data'][0]->flash_price+0}}                                                @elseif(!empty($result['detail']['product_data'][0]->discount_price))
                                                	{{$web_setting[19]->value}}{{$result['detail']['product_data'][0]->products_min_order*$result['detail']['product_data'][0]->discount_price+0}}
                                                @else
                                                	{{$web_setting[19]->value}}{{$result['detail']['product_data'][0]->products_min_order*$result['detail']['product_data'][0]->products_price+0}}
                                                @endif
                                                </span>				
                                            </div>  
