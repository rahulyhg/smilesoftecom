    ...
    <td>
        ...
        <div class="input-group input-number">
            ...
            <input type="text" data-min="1" id="qty{{$products->products_id}}" class="form-control pos_quantity input_number mousetrap input_quantity"
                   ...
                   data-msg-required="This field is required" data-rule-max-value="{{$stock}}" data-qty_available="{{$stock}}"
                   data-msg-max-value="Only {{$stock}} Pc(s) available" data-msg_max_default="Only {{$stock}} Pc(s) available">
