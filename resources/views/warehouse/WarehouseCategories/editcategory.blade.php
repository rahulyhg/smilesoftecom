    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ URL::to('listingCategories')}}"><i class="fa fa-bars"></i> {{ trans('labels.ListAllCategories') }}</a></li>
                        ...
                        <div class="box-body">
                          ...
                          <h3 class="box-title">Edit category</h3>
                                        ...
                                        <div class="box-body">
                                            ...
                                            {!! Form::open(array('url' =>'updatecategory', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                            ...
                                            <div class="box-footer text-center">
                                                ...
                                                <a href="{{ URL::to('categories')}}" type="button" class="btn btn-default">{{ trans('labels.back') }}</a>
                                            </div>
                                            <!-- /.box-footer -->
                                            {!! Form::close() !!}
                                        </div>
