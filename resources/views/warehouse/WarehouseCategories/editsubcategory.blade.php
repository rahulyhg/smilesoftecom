    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ URL::to('subcategories')}}"><i class="fa fa-bars"></i> {{ trans('labels.SubCategories') }}</a></li>
                        ...
                        <div class="box-body">
                          ...
                          <h3 class="box-title">Edit category</h3>
                                        ...
                                        <div class="box-body">
                                            ...
                                            {!! Form::open(array('url' =>'updatesubcategory', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                            ...
                                            <div class="box-footer text-center">
                                                ...
                                                <a href="{{ URL::to('subcategories')}}" type="button" class="btn btn-default">{{ trans('labels.back') }}</a>
                                            </div>
                                            <!-- /.box-footer -->
                                            {!! Form::close() !!}
                                        </div>
