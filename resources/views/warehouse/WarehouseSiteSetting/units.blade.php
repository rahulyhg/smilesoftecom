                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="box-tools pull-right">
                                <a href="{{ URL::to('addunit')}}" type="button" class="btn btn-block btn-primary">{{ trans('labels.AddUnit') }}</a>
                            </div>
                        </div>
            ...
            <div class="modal fade" id="deleteUnitModal" tabindex="-1" role="dialog" aria-labelledby="deleteUnitsModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        {!! Form::open(array('url' =>'deleteunit', 'name'=>'deleteunits', 'id'=>'deleteunits', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
