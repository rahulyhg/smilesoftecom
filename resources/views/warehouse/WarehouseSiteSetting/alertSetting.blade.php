                                ...
                                <div class="col-xs-12">
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            {!! Form::open(array('url' =>'updateAlertSetting', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
                                            ...
                                            <div class="form-group">
                                                <label for="shippingEnvironment" class="col-sm-2 col-md-3 control-label" style="">Prime Percent</label>
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text('prime_discount_percent',  $result['setting'][0]->prime_discount_percent, array('class'=>'form-control', 'id'=>'prime_discount_percent')) !!}
                                                    <span class="help-block"
                                                          style="font-weight: normal;font-size: 11px;margin-bottom: 0;">Enter Prime Customer Percent Discount</span>
                                                    {{--<span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.newsnotificationtext') }}</span>--}}
                                                </div>
                                            </div>
                                            ...
                                            <div class="box-footer text-center">
                                                ...
                                                <a href="{{ URL::to('warehouse_dashboard')}}" type="button" class="btn btn-default">{{ trans('labels.back') }}</a>
                                            </div>
