                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="box-tools pull-right">
                                <a href="{{ URL::to('addmanufacturer') }}" type="button"
            ...
            <div class="modal fade" id="manufacturerModal" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        {!! Form::open(array('url' =>'deletemanufacturer', 'name'=>'deleteManufacturer', 'id'=>'deleteManufacturer', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
