...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> {{ trans('labels.AddOptions') }}
                <small>{{ trans('labels.AddOptions') }}...</small>
            </h1>
            <ol class="breadcrumb">
                                                ...
                                                @if($products_attributes->is_default == '1')
                                                    ...
                                                    <!--<td>{{ $products_attributes->price_prefix }}{{ $products_attributes->options_values_price }}</td>-->
                                                        <td>
                                                            ...
                                                            <a products_id='{{ $products_attributes->products_id }}'
                                                               products_attributes_id="{{ $products_attributes->products_attributes_id }}"
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10 col-md-8">
                                                            <select class="form-control  additional-option-id field-validate"
                                                                    name="products_options_id">
                                                                <option value=""
								  ...
								  {{ trans('labels.OptionNameText') }}
                                                    ...
                                                    <div class="form-group">
                                                        <label for="name"
                                                               class="col-sm-2 col-md-4 control-label">{{ trans('labels.OptionValues') }}</label>
                                                        <div class="col-sm-10 col-md-8">
                                                            <select class="form-control additional_products_options_values_id field-validate"
                                                                    name="products_options_values_id">
                                                            </select>
                                                            <span class="help-block"
                                                                  style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                            ...
                            <div class="box-footer text-center">
                                ...
                                <a href="{{ URL::to("addinventory/{$result['data']['products_id']}")}}"
                                   class="btn btn-primary pull-right">{{ trans('labels.Add Stock') }} <i
