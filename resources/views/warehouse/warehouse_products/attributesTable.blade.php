    ...
    <tr @if($key++==0) id="content_<?=$values_data->products_options_id.'_'.$values_data->language_id?>" @endif>
        <td>
            ...
            <div style="display:none" class="row form-content-<?=$values_data->products_options_id.$values_data->products_options_values_id?>">
                {!! Form::open(array('url' =>'updateAttributeValue', 'method'=>'post', 'class' => 'form-horizontal form-validate editvalue-form', 'enctype'=>'multipart/form-data')) !!}
...
<tr>
    <td colspan="2">
        {!! Form::open(array('url' =>'addAttributeValue', 'method'=>'post', 'class' => 'form-horizontal form-validate addvalue-form', 'enctype'=>'multipart/form-data')) !!}
