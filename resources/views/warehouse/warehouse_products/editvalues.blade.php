...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="{{ URL::to("warehouse_dashboard")}}"><i class="fa fa-dashboard"></i>{{ trans('labels.Home') }} </a></li>
                <li><a href="{{ URL::to("attributes")}}"><i class="fa fa-dashboard"></i> {{ trans('labels.ListingOptions') }}</a></li>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="box box-info"><br>
                                        ...
                                        <div class="box-body">
                                            {!! Form::open(array('url' =>'updatevalue', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                        ...
                                        <!-- /.box-body -->
                                            <div class="box-footer text-center">
                                                ...
                                                <a href="{{ URL::to("manage-options-values/".$result['editoptions'][0]->products_options_id)}}" type="button" class="btn btn-default">{{ trans('labels.back') }}</a>
                                            </div>
