                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="box-tools pull-right">
                                <a href="{{ URL::to('addproduct') }}" type="button" class="btn btn-block btn-primary">{{ trans('labels.AddNewProducts') }}</a>
                            </div>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <form class="form-inline form-validate" enctype="multipart/form-data">
                                        ...
                                        <a href="{{ URL::to('products')}}" class="btn btn-danger">{{ trans('labels.ClearSearch') }}</a>
                                    </form>
                                </div><br><br><br>
