                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="box box-info">
                                                            ...
                                                            <!-- /.box-header -->
                                                            <div class="box-body">
                                                                {!! Form::open(array('url' =>'addnewstock', 'name'=>'inventoryfrom', 'id'=>'addewinventoryfrom', 'method'=>'post', 'class'
                                                                => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data'))
                                                                !!} {!! Form::hidden('products_id', $result['products'][0]->products_id,
                                                                array('class'=>'form-control', 'id'=>'products_id')) !!}
                                                                @if(count($result['attributes'])==0 and $result['products'][0]->products_type==1)
                                                                <div class="alert alert-danger" role="alert">
                                                                    You can not add stock without attribute for variable product
                                                                </div>
                                                                @endif @if($result['products'][0]->products_type==1)
                                          ...
                                          {{ trans('labels.Select Option values Text') }}.</span>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="name" class="col-sm-2 col-md-4 control-label">
                                                                        ...
                                                                        $warehouse_id = session('warehouse')->id; $warehouseModel= \App\WarehouseModel:: where(['is_del'=>0, 'id'=>$warehouse_id])->get();
...
@endphp
                                                                    <div class="col-sm-10 col-md-8">
                                                                        {{--
                                                                        <p id="current_stocks" --}} <p id="currentstocks"
                                                                            style="width:100%">{{ isset($wstock->stock)?$wstock->stock:'0' }}</p>
                                                                        <br>
                                                                    </div>
                                                                    <input type="hidden" name="stock" id="stock" value="{{ isset($wstock->stock)?$wstock->stock:'0' }}">                                                                    {{--

                                                                    <div class="col-sm-10 col-md-8">--}} {{--
                                                                        <p id="current_stocks" --}} {{--style="width:100%">{{$result['stocks']}}</p>--}} {{--
                                                                        <br>--}} {{--
                                                                    </div>--}} {{--
                                                                    <input type="hidden" name="stock" id="stock" --}} {{--value="{{$result['stocks']}}">--}}
                                                                    @endforeach
                                                                </div>
                                                                @php $warehouse_id = session('warehouse')->id; 
                                                                $warehouseModel = \App\WarehouseModel:: where(['is_del'=>0, 'id'=>$warehouse_id])->get();
                                                                
@endphp @foreach ($warehouseModel as $wobject)
                                                                <div class="myrow"></div>
                                                                @php $wstock = \App\Warehouse_Inventory_Model::where(['pid' => $result['products'][0]->products_id ,'w_id' =>$wobject->id])->first();
...
@endphp
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-10 col-md-8">
                                                                        <p id="current_stocks" style="width:100%">{{ isset($wstock->stock)?$wstock->stock:'0' }}</p>
                                                                        <br>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-10 col-md-8">
                                                                        <p class="purchase_price_content" style="width:100%;margin-top: 7px;">
                                          ...
                                          {{ trans('labels.Reference / Purchase Code Text') }}</span>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="box box-danger">
                                                            ...
                                                            <!-- /.box-header -->
                                                            <div class="box-body">
                                                                {!! Form::open(array('url' =>'addminmax', 'name'=>'addminmax', 'id'=>'addminmax', 'method'=>'post', 'class' => 'form-horizontal
                                                                form-validate-level', 'enctype'=>'multipart/form-data'))
                                                                !!} {!! Form::hidden('products_id', $result['products'][0]->products_id,
                                                                array('class'=>'form-control', 'id'=>'products_id')) !!}
                                                                @if($result['products'][0]->products_type==1) {!! Form::hidden('inventory_ref_id',
                                                                '', array('class'=>'form-control check_reference_id', 'id'=>'inventory_ref_id'))
                                                                !!} @endif
                                            ...
                                            {{ trans('labels.Min Level Text') }}</span>
                                                                ...
                                                                <div class="alert alert-danger alert-dismissible" id="minmax-error" role="alert" style="display: none">
                                                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                                        ...
                                                                        </button>                                                                    {{ trans('labels.This stock is not asscociated with any
                                                                    attributes. Please choose products attributes first')
                                                                    }}
                                                                </div>
                                                                <!-- /.users-list -->
                                                            </div>
                                            ...
                                            <div class="box-footer col-xs-12">
                                                @if($result['products'][0]->products_type==1)
                                                <a href="{{ URL::to('addproductattribute/'.$result['products'][0]->products_id) }}" class="btn btn-default pull-left">{{ trans('labels.AddOptions') }}</a>                                                @else
                                                <a href="{{ URL::to(" products ")}}" class="btn btn-default pull-left"> <i
