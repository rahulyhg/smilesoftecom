                                        ...
                                        <div class="box-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="box box-info">
                                                                ...
                                                                <!-- /.box-header -->
                                                                <div class="box-body">
                                                                    {!! Form::open(array('url' =>'addnewstock', 'name'=>'inventoryfrom', 'id'=>'addewinventoryfrom', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                          ...
                                          {{ trans('labels.Select Option values Text') }}.</span>
                                                                    ...
                                                                    @foreach ($warehouseModel as $wobject)
                                                                        @if($wobject->id == session('warehouse')->id)
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-10 col-md-8">
                                                                                    <p id="current_stocks"
                                                                                       style="width:100%">{{ $wstock->stock }}</p>
                                                                                    <br>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="box box-danger">
                                                                ...
                                                                <!-- /.box-header -->
                                                                <div class="box-body">
                                                                    {!! Form::open(array('url' =>'addminmax', 'name'=>'addminmax', 'id'=>'addminmax', 'method'=>'post', 'class' => 'form-horizontal form-validate-level', 'enctype'=>'multipart/form-data')) !!}
                                                                    {!! Form::hidden('products_id',  $result['products'][0]->products_id, array('class'=>'form-control', 'id'=>'products_id')) !!}
