    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ URL::to('products') }}"><i class="fa fa-database"></i>{{ trans('labels.ListingAllProducts') }}</a></li>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div class="box-footer text-center">
                                <a href="{{ URL::to("products")}}" class="btn btn-primary">{{ trans('labels.SaveUpdate') }}</a>
                            </div>
                        </div>
                        ...
                        <div class="modal fade" id="addImagesModal" tabindex="-1" role="dialog" aria-labelledby="addImagesModalLabel">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    {!! Form::open(array('url' =>'addNewProductImage', 'name'=>'addImageFrom', 'id'=>'addImageFrom', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
