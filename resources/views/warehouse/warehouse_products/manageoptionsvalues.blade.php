                ...
                <div class="col-md-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    {!! Form::open(array('url' =>'addnewvalues', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                    ...
                                    <div class="">
                                        <a href="{{ URL::to('attributes')}}" type="button" class="btn btn-default pull-left"><i class="fa fa-angle-left"></i> {{ trans('labels.attributes') }}</a>
                                        ...
                                        @if(count($result['content'])>0)
                                            @foreach($result['content'] as $data)
                                                <tr id="tr_parent_{{$data->products_options_values_id}}">
                                                    ...
                                                    <td><a data-toggle="tooltip" data-placement="bottom" title="" href="{{ URL::to('edit-values/')}}/{{$data->products_options_values_id}}" class="badge bg-light-blue" data-original-title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
            ...
            <div class="modal fade" id="deleteValueModal" tabindex="-1" role="dialog" aria-labelledby="deleteValueModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        {!! Form::open(array('url' =>'deletevalue', 'name'=>'deleteValue', 'id'=>'deleteValue', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
