...
class WarehouseCategoriesController extends Controller
{
    ...
    public function categories()
    {
        if (session('categories_view') == 0) {
            ...
            return view("warehouse.WarehouseCategories.categories", $title)->with('categories', $categories);
        }
    }
    ...
    public function addcategory(Request $request)
    {
        ...
        return view("warehouse.WarehouseCategories.addcategory", $title)->with('result', $result);
    }
    ...
    public function editcategory(Request $request)
    {
        ...
        return view("warehouse.WarehouseCategories.editcategory", $title)->with('result', $result);
    }
    ...
    public function subcategories()
    {
        ...
        return view("warehouse.WarehouseCategories.subcategories", $title)->with('listingSubCategories', $listingSubCategories);
    }
    ...
    public function addsubcategory(Request $request)
    {
        ...
        return view("warehouse.WarehouseCategories.addsubcategory", $title)->with('result', $result);
    }
    ...
    public function editsubcategory(Request $request)
    {
        ...
        return view("warehouse.WarehouseCategories.editsubcategory", $title)->with('result', $result);
    }
