...
class WarehouseSiteSettingController extends Controller
{
    ...
    public function orderstatus(Request $request)
    {
        ...
        return view("warehouse.WarehouseSiteSetting.orderstatus", $title)->with('result', $result);
    }
    ...
    public function addorderstatus(Request $request)
    {
        ...
        return view("warehouse.WarehouseSiteSetting.addorderstatus", $title)->with('result', $result);
    }
...
//editorderstatus
    public function editorderstatus(Request $request)
    {
        ...
        return view("warehouse.WarehouseSiteSetting.editorderstatus", $title)->with('result', $result);
    }
...
//languages
    public function languages(Request $request)
    {
        ...
        return view("warehouse.WarehouseSiteSetting.languages", $title)->with('result', $result);
    }
...
//addLanguages
    public function addlanguages(Request $request)
    {
        ...
        return view("warehouse.WarehouseSiteSetting.addlanguages", $title);
    }
...
//editOrderStatus
    public function editlanguages(Request $request)
    {
        ...
        return view("warehouse.WarehouseSiteSetting.editlanguages", $title)->with('result', $result);
    }
...
//setting page
    public function setting(Request $request)
    {
        ...
        return view("warehouse.WarehouseSiteSetting.setting", $title)->with('result', $result);
    }
...
//applicationApi
    public function applicationApi(Request $request)
    {
        ...
        return view("warehouse.WarehouseSiteSetting.applicationApi", $title)->with('result', $result);
    }
...
//webSettings
    public function webSettings(Request $request)
    {
        ...
        return view("warehouse.WarehouseSiteSetting.webSettings", $title)->with('result', $result);
    }
...
//customstyle
    public function customstyle(Request $request)
    {
        ...
        $settings = DB::table('settings')->get();
        $result['settings'] = $settings;
        return view("warehouse.WarehouseSiteSetting.customstyle", $title)->with('result', $result);
    }
...
//appSettings
    public function appSettings(Request $request)
    {
        ...
        return view("warehouse.WarehouseSiteSetting.appSettings", $title)->with('result', $result);
    }
...
//seo
    public function seo(Request $request)
    {
        ...
        return view("warehouse.WarehouseSiteSetting.seo", $title)->with('result', $result);
    }
...
//admobSettings
    public function admobSettings(Request $request)
    {
        ...
        return view("warehouse.WarehouseSiteSetting.admobSettings", $title)->with('result', $result);
    }
...
//facebookSettings
    public function facebookSettings(Request $request)
    {
        ...
        return view("warehouse.WarehouseSiteSetting.facebookSettings", $title)->with('result', $result);
    }
...
//googleSettings
    public function googleSettings(Request $request)
    {
        ...
        return view("warehouse.WarehouseSiteSetting.googleSettings", $title)->with('result', $result);
    }
...
//setting page
    public function alertSetting(Request $request)
    {
        ...
        return view("warehouse.WarehouseSiteSetting.alertSetting", $title)->with('result', $result);
    }
...
//alertSetting
    public function updateAlertSetting(Request $request)
    {
        $orders_status = DB::table('alert_settings')->where('alert_id', '=', $request->alert_id)->update([
            ...
            'prime_discount_percent' => $request->prime_discount_percent,
        ]);
...
//websiteThemes
    public function webthemes(Request $request)
    {
        ...
        return view("warehouse.WarehouseSiteSetting.webthemes", $title)->with('result', $result);
    }
...
//pushNotification
    public function pushNotification(Request $request)
    {
        ...
        $settings = DB::table('settings')->get();
        $result['settings'] = $settings;
        return view("warehouse.WarehouseSiteSetting.pushNotification", $title)->with('result', $result);
    }
...
//orderstatus
    public function units(Request $request)
    {
        ...
        return view("warehouse.WarehouseSiteSetting.units", $title)->with('result', $result);
    }
...
//addunit
    public function addunit(Request $request)
    {
        ...
        return view("warehouse.WarehouseSiteSetting.addunit", $title)->with('result', $result);
    }
...
//editunit
    public function editunit(Request $request)
    {
        ...
        $result['units'] = $units;
        return view("warehouse.WarehouseSiteSetting.editunit", $title)->with('result', $result);
    }
