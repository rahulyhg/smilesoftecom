	...
	public function processregistration(Request $request){
		...
		if($authenticate==1){
			...
			if($error==0){
				...
				$responseData = array('success'=>'0', 'data'=>array(), 'message'=>"Invalid image is uploaded");
			}
		}else{
			$responseData = array('success'=>'0', 'data'=>array(),  'message'=>"Unauthenticated call.");
		}
	...
	public function updatecustomerinfo(Request $request){
		...
		if($authenticate==1){
			...
			if($exist==0 and $error==0){
				...
				$responseData = array('success'=>'2', 'data'=>array(),  'message'=>$message);
			}
